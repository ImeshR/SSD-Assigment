...
const ManageShowroom = () => {
  ...
  const handleSubmit = async (event) => {
            ...
            .then((url2) => {
              ...
              getDownloadURL(storageRef3)
                .then((url3) => {
                  ...
                  axios
                    .post(
                      "http://localhost:8080/api/Showroom/",
                      showroomDetails
                    )
                    .then((res) => {
    ...
    //await axios.post("http://localhost:8080/api/Showroom/", showroomDetails)
  };
  ...
  return (
    <div>
      ...
      <div className={styles.content}>
        ...
        <BreadCrumb home={home} className={styles.breadcrumb__path} />
            ...
            <div className={styless.formbody}>
              <form className={styless.showroomForm} onSubmit={handleSubmit}>
                ...
                <div className={styless.showroomItem}>
                  ...
                  />
                  {errors.name && (
                    <span className={styless.error_message}>{errors.name}</span>
                  )}
                </div>
                <div className={styless.showroomItem}>
                ...
                <div className={styless.showroomItem}>
                  ...
                  />
                  {errors.city && (
                    <span className={styless.error_message}>{errors.city}</span>
                  )}
                </div>
                <div className={styless.showroomItem}>
                ...
                <div className={styless.showroomItem}>
                  ...
                  <button type="submit" className={styless.showroomButton}>
                    Add
                  </button>
                </div>
