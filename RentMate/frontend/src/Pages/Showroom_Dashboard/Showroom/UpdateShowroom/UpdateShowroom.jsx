...
const UpdateShowroom = () => {
  ...
  const items = [
    ...
    { label: "Showroom", url: "/showroomOwner/showroom" },
    {
      ...
      url: "/showroomOwner/showroom/update-showroom",
    },
  ];
  ...
  useEffect(() => {
    const fetchData = async () => {
      await axios
        .get(`http://localhost:8080/api/Showroom/${ShowroomID}`)
  ...
  const updateFunction = async () => {
    await axios
      .put(`http://localhost:8080/api/Showroom/${ShowroomID}`, showroomDetails)
                ...
                <form className={styless.showroomForm} onSubmit={handleSubmit}>
                  <div className={styless.showroomItem}>
                    ...
                    <input
                      type="text"
                      name="name"
                      defaultValue={showroomDetails.name}
                  ...
                  <div className={styless.showroomItem}>
                    ...
                    <input
                      type="email"
                      name="email"
                      defaultValue={showroomDetails.email}
                      onChange={handleInputChange}
                      required
                      disabled
                    />
                  ...
                  <div className={styless.showroomItem}>
                    ...
                    <input
                      type="text"
                      name="address"
                      defaultValue={showroomDetails.address}
                      onChange={handleInputChange}
                      required
                    />
                  </div>
                  <div className={styless.showroomItem}>
                    ...
                    <input
                      type="text"
                      name="city"
                      defaultValue={showroomDetails.city}
                      onChange={handleInputChange}
                      required
                    />
                  </div>
                  <div className={styless.showroomItem}>
                    ...
                    <input
                      type="text"
                      name="openingTime"
                      defaultValue={showroomDetails.openingTime}
                      onChange={handleInputChange}
                      required
                    />
                  </div>
                  <div className={styless.showroomItem}>
                    ...
                    <input
                      type="text"
                      name="contactNumber"
                      defaultValue={showroomDetails.contactNumber}
                      onChange={handleInputChange}
                      maxLength={10}
                      minLength={10}
                      pattern="[0-9]+"
                  ...
                  <div className={styless.showroomButton}>
                    <button
                      type="submit"
                      className={styless.showroomButtonUpdate}
                    >
                      Update
                    </button>
