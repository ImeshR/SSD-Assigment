...
const Customer_Property = () => {
  ...
  const updateCusdata = (id) => {
    ...
    axios
      .put(`http://localhost:8080/api/customer/updatepropertybooking/${id}`, {
        cus_name: name,
        contactNo: phone,
      })
      .then((res) => {
  ...
  const handleDalertVisibility = (id) => {
    console.log(id);
    axios
      .delete(`http://localhost:8080/api/customer/deletepropertybooking/${id}`)
      .then((res) => {
        console.log(res.data);
        Swal.fire({
          icon: "success",
  ...
  useEffect(() => {
    ...
    function getTodo() {
      axios(`http://localhost:8080/api/customer/getpropertybooking/${userid}`)
        .then((res) => {
          ...
          <div className={styles.main_card}>
            <div className={styles.cp_container}>
              <div className={styles.cp_container_title}>
                <span className={styles.cp_container_title_span}>
                  All About Your Bookings
                </span>
                <span className={styles.cp_container_title_span_sub1}>
                  manage your proprty booking here.(Limitaion for some Details
                  Updating)
                </span>
              </div>
                  ...
                  <div className={styles.formE}>
                    ...
                    <div className={styles.form_cp_e}>
                      <form className={styles.form_cp}>
                        ...
                        <button
                          type="submit"
                          onClick={() => updateCusdata(selectedBooking._id)}
                        >
                          Submit
                        </button>
                      </form>
                ...
                {isdataview && selectedBooking && (
                  <div className={styles.dataForm}>
                    <div className={styles.closeBtn}>
                      <FontAwesomeIcon
                        className={styles.close}
                        onClick={handleDataVisibility}
                        icon={faXmark}
                        size="xl"
                      />
                    </div>
                    <div className={styles.data_view}>
                      <span className={styles.data_view_span}>
                        See Full details about your booking
                      </span>
                      <div className={styles.data_master}>
                        <h1 className={styles.data_master_h1}>
                          Property Details
                        </h1>
                        <div className={styles.data_container}>
                          <span className={styles.data_container_span1}>
                            Property Name :
                          </span>
                          <span className={styles.data_container_span2}>
                        ...
                        <div className={styles.data_container}>
                          ...
                          <span className={styles.data_container_span2}>
                            {selectedBooking.propprice}
                          </span>
                        </div>
                        <div className={styles.data_container}>
                          <span className={styles.data_container_span1}>
                            Agrement Period (Months) :
                          </span>
                          <span className={styles.data_container_span2}>
                            Eshan Imesh
                          </span>
                        ...
                        <div className={styles.data_container}>
                          ...
                          <span className={styles.data_container_span2}>
                            {selectedBooking.propcalculatedPrice}
                          </span>
                        </div>
                        <div className={styles.data_container}>
                          <span className={styles.data_container_span1}>
                            Rentmate service Charge :
                          </span>
                          <span className={styles.data_container_span2}>
                            {selectedBooking.proptaxPrice}
                          </span>
                        </div>
                        <div className={styles.data_container}>
                          <span className={styles.data_container_span1}>
                      ...
                      <tr key={booking.id} className={styles.table_cp_tr2}>
                        ...
                        <td className={styles.table_cp_td}>
                          <div className={styles.table_btn_conatiner}>
                            <button
                              className={styles.eshan_btn_up}
                              onClick={() => handleNameFormVisibility(booking)}
                            >
                              Update
                            </button>
                            <button
                              className={styles.eshan_btn_can}
                              onClick={() =>
                                handleDalertVisibility(booking._id)
                              }
                            >
                              Cancel
                            </button>
                            <button
                              className={styles.eshan_btn_vi}
                              onClick={() => handleDataVisibility(booking)}
                            >
                              View
                            </button>
                          </div>
