...
const Customer_Info = () => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .put(`http://localhost:8080/api/customer/updatename/${userid}`, {
  ...
  const handleSubmit2 = (event) => {
    ...
    axios
      .put(`http://localhost:8080/api/customer/updateemail/${userid}`, {
  ...
  const handleSubmit3 = (event) => {
    ...
    axios
      .put(`http://localhost:8080/api/customer/updatephone/${userid}`, {
  ...
  const handleSubmit4 = (event) => {
    ...
    axios
      .put(`http://localhost:8080/api/customer/updateaddress/${userid}`, {
  ...
  const handleSubmit5 = (event) => {
    ...
    axios
      .put(`http://localhost:8080/api/customer/updatecity/${userid}`, {
  ...
  const handleSubmit6 = () => {
    ...
    axios
      .put(`http://localhost:8080/api/customer/updateavatar/${userid}`, data)
      .then((res) => {
              ...
              <div className={styles.div3}>
                ...
                <div className={styles.content}>
                  ...
                  <div className={styles.btn_container}>
                    <div>
                      <FontAwesomeIcon
                        icon={faPenToSquare}
                        onClick={handlePhoneNumberFormVisibility}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className={styles.content}>
                  ...
                  <div className={styles.btn_container}>
                    <div>
                      <FontAwesomeIcon
                        icon={faPenToSquare}
                        onClick={handleAddressFormVisibility}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className={styles.content}>
                  ...
                  <div className={styles.btn_container}>
                    <div>
                      <FontAwesomeIcon
                        icon={faPenToSquare}
                        onClick={handleCurrentCityFormVisibility}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className={styles.content}>
                  ...
                  <div className={styles.upload_btn}>
                    <div>
                      <button onClick={handlePhotoFormVisibility}>
                        + Upload
                      </button>
                    </div>
                  </div>
                ...
                {isPhotoVisible && (
                  <div className={styles.form}>
                    ...
                    <div className={styles.closeBtn}>
                      <FontAwesomeIcon
                        className={styles.close}
                        onClick={handlePhotoFormVisibility}
                        icon={faXmark}
                      />
                    </div>
                  </div>
