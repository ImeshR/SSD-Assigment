...
const Customer_Privacy = () => {
  ...
  const HandleDelete = () => {
    ...
    axios
      .delete(`http://localhost:8080/api/customer/delete_customer/${userid}`)
      .then((res) => {
          ...
          <div className={styles.main_card}>
            ...
            <div className={styles.privacy_content}>
              ...
              <div className={styles._46}>
                <button onClick={handleConfirmFormVisibility}>
                  Delete Account
                </button>
              </div>
            </div>
                ...
                <div className={styles.Container}>
                  <div className={styles.text}>
                    <span>
                      ...
                      delete your account permenantly and you can't recover your
                      account again.
                    </span>
                  </div>
                  <div className={styles.btncontainer}>
                    ...
                    <button
                      className={styles.no}
                      onClick={handleConfirmFormVisibility}
                    >
                      No,Cancel
                    </button>
                  </div>
