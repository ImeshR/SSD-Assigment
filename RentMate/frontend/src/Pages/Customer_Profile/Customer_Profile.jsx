...
const Customer_Profile = () => {
  ...
  const submitHandler = (e) => {
    ...
    e.preventDefault();
    axios
      .post("http://localhost:8080/api/customer/insert", {
        userid: userid,
        content: task,
      })
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8080/api/customer/getpropertybooking/${userid}`)
      .then((res) => {
  ...
  useEffect(() => {
    function getTodos() {
      axios(`http://localhost:8080/api/customer/gettodo/${userid}`)
        .then((res) => {
          setTodos(res.data);
          ...
          <div className="main_card">
            ...
            <div className="status_bar">
              <div className="content1">
                <h1 className="prop_book">0{dataCount}</h1>
              </div>
              <div className="content2">
                <h1 className="trans_book">00</h1>
              </div>
            </div>
              ...
              <div className="todo_container">
                <div className="todo_list">
                  ...
                  <div className="display_todo">
                    {todos.map((eshan) => (
                      <>
                        <span className="display_todo_content">
                          🛑{eshan.content}
                        </span>
                        <br />
                      </>
