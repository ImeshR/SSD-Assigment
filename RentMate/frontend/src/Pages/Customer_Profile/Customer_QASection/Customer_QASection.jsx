...
const Customer_QASection = () => {
  ...
  useEffect(() => {
    function getProblems() {
      axios
        .get("http://localhost:8080/api/problems/user/" + id)
        .then((res) => {
                  ...
                  <table>
                    <thead>
                      <tr>
                        <th>
                          {" "}
                          Problem <span className="icon-arrow"></span>
                        </th>
                        <th>
                          {" "}
                          Reply <span className="icon-arrow"></span>
                        </th>
                        <th>
                          {" "}
                          Date <span className="icon-arrow"></span>
                        </th>
                        <th>
                          {" "}
                        ...
                        <tr key={problem._id}>
                          ...
                          <td>
                            ...
                            {problem.status === "Pending" ? (
                              <p className={styles.status_pending}>
                                {problem.status}
                              </p>
                            ) : (
                              <p className={styles.status_solved}>
                                {problem.status}
                              </p>
                            )}
                          </td>
