    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      await getDownloadURL(storageRef)
        .then((url) => {
          ...
          console.log(values);
          // axios.put(`http://localhost:8080/api/lawyer/${lawyerID}`, values)
          //   .then((res) => {
          //     console.log(res)
          //   })

          axios
            .put(`http://localhost:8080/api/lawyer/${lawyerID}`, updatedLawyer)
            .then((res) => {
          ...
          <div className={styles.main_card}>
            <div className={styles.subcard}>
              ...
              <div className={styles.newUser}>
                <div className={styles.newUserTitle}>
                  <b>Update Profile Listing Form</b>
                </div>
                <div className={styles.newUsersubTitle}>
                  <b></b>
                </div>
