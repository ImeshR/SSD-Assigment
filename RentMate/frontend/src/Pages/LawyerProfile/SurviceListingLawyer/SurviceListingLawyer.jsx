    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      await getDownloadURL(storageRef)
        .then((url) => {
          ...
          axios
            .post("http://localhost:8080/api/lawyer/", newLawyer)
            .then((response) => {
            ...
            <div className={styles.subcard}>
              ...
              <div className={styles.newUser}>
                <div className={styles.newUserTitle}>
                  <b>Survice Listing Form</b>
                </div>
                <div className={styles.newUsersubTitle}>
                  <b>Hi!! Do you want to publish your service?</b>
                </div>
                <form className={styles.newUserForm} onSubmit={handleSubmit}>
                  ...
                  <div className={styles.newUserRow}>
                    <div className={styles.newUserItem}>
                      ...
                      <input
                        ...
                        name="contactNumber"
                        value={lawyerDetails.contactNumber}
                        onChange={handleInputChange}
                      />
                  ...
                  <div className={styles.newUserRow}>
                    <div className={styles.newUserItem}>
                      ...
                      <input
                        type="text"
                        placeholder="Enter Practice Courts"
                        name="courts"
                        onChange={handleInputChange}
                      />
                      {errors.courts && (
