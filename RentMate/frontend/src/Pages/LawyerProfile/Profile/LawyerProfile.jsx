...
const LawyerProfile = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8080/api/lawyer/user/${userid}`)
            ...
            <div className={styless.subcard}>
              <div className={styless.detail}>
                <div className={styless.details_container}>
                  ...
                  <div className={styless.subDetail}></div>
                </div>
