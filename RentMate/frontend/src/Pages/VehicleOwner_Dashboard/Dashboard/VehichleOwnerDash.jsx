...
const VehichleOwnerDash = ({ type }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      await axios
        .get(
          "http://localhost:8080/api/vehi/user/" + localStorage.getItem("id")
        )
  ...
  //end
  const items = [{ label: "Dashboard", url: "/vehicleOwner" }];
