...
function Checkout() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      await axios
        .post("http://localhost:8080/reservation/add", data)
              ...
              <div>
                ...
                <table border={0} className={styles.add_Details_Table}>
                  {filteredData.map((data) => (
                    <tr>
                      <td className={styles.card_data} width={30}>
                        <input
                          type="radio"
                          name="radioBtn"
                      ...
                      <td className={styles.card_data} width={150}>
                        {data.name}
                      </td>
                      <td className={styles.card_data} width={200}>
                        {data.cardNumber}
                      </td>
                      <td className={styles.card_data} width={50}>
                        {data.cardType}
                      </td>
                    </tr>
                  ))}
