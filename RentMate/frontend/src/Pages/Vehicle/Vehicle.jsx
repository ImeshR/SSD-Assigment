...
const Vehicle = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8080/api/vehi/${id}`)
      .then((res) => {
        setVehicle(res.data);
  ...
  const handleFormSubmit = (event) => {
    ...
    axios
      .post("http://localhost:8080/api/bookingVehicle", formData)
      .then((response) => {
    ...
    <div>
      ...
      <div className={styles.house_details}>
        ...
        <div className={styless.parallax_container}>
          <div className={styless.mainbody5}>
            ...
            <div className={styless.userShowBottom}>
              ...
              <div className={styless.userShowInfo}>
                ...
                <span className={styless.userShowInfoTitle}>
                  Capacity:-Ton 2000
                </span>
              </div>
              <div className={styless.userShowInfo}>
              ...
              <div className={styless.userShowInfo}>
                ...
                <span className={styless.userShowInfoTitle}>
                  Rate:-Rs.{vehicle.price} Per Rental
                </span>
              </div>
              <div className={styless.userShowInfo}>
                <div className={styless.userShowIcon}>
              ...
              <div className={styless.userShowInfo}>
                ...
                <span
                  className={styless.userShowInfoTitle}
          ...
          <div className={styless.mainbody5}>
            <form
              className={styless.reservation_form}
